...
#pragma HLS ARRAY_PARTITION variable=data_hw_tmp factor=32 cyclic dim=2
#pragma HLS ARRAY_PARTITION variable=movie_tmp factor=32 cyclic dim=1
#pragma HLS ARRAY_PARTITION variable=dists_hw_tmp factor=32 cyclic dim=1
